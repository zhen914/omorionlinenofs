...
Window_OmoriAlbumLegend.prototype.refresh = function(canRead = true) {
  ...
  if (textList) {
    ...
    for (var i = 0; i < textList.length; i++) {
      ...
      // Draw Header Text
      this.contents.drawText(data.text, sx, -2, tw, this.contents.height);
