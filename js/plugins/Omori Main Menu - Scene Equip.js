...
Window_OmoMenuActorEquip.prototype.refresh = function() {
  ...
  // Draw Headers
  this.contents.fontSize = 18; //20 「武器」「装飾品」のサイズ
  ...
  this.drawText(LanguageManager.getPluginText('equipMenu', 'weapon'), 0, -2, this.width, 'center'); // -4 「武器」のY座標変更
  this.drawText(LanguageManager.getPluginText('equipMenu', 'charm'), 0, 60, this.width, 'center'); // 58 「装飾品」のY座標変更
};
//=============================================================================
// * Draw Item
//=============================================================================
Window_OmoMenuActorEquip.prototype.drawItem = function(index) {
  ...
  // Set Font Size
  this.contents.fontSize = 22; // 24 アイテム名のサイズ   
  // Draw Text
  this.contents.drawText(text, rect.x, rect.y + 7, rect.width, rect.height); //アイテム名のY座標変更
  this.changePaintOpacity(true)  
};
//=============================================================================
// * Update Help
