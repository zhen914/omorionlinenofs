...
Scene_OmoBlackLetterMenu.prototype.createHangmanHeaderHelpWindow = function() {
  ...
  this._hangmanHeaderHelpwindow.contents.fontSize = 20;
  this._hangmanHeaderHelpwindow.drawText(LanguageManager.getMessageData("XX_BLUE.Omori_Blackletter_Menu").collect_desc, 5, -5, 400, 40);
  this._hangmanHeaderHelpwindow.drawText(LanguageManager.getMessageData("XX_BLUE.Omori_Blackletter_Menu").incorrect_desc, 5, 17, 400, 40);
