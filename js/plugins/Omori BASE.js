...
Window_OmoMenuHelp.prototype.refresh = function() {
  ...
  if (this._item) {
    ...
    this.drawTextEx(this._item.description, 6, +28, 28); // CHANGE: Item descriptions text (6, +28, 28)
    // Get Icon width
    ...
    win.update = function(animPhase) {
      if (animPhase == 2) {
        ...
        if (this.drawOpacity < 255) {
          ...
          win.contents.drawText(this.textToDraw, 0, 0, this.contents.width, this.contents.height, 'center');
        }
      } else if (animPhase == 4) {
        this.contents.clear();
        this.drawOpacity -= 4;
